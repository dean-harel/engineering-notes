Remember that time when Elon Musk bought Twitter (now X) and promptly asked engineers to print out their code? Screenshots of their most salient lines; Then reportedly stack-ranked them by LOC written in the past year and cut the bottom tier (around 3,250 people)?
...
Well, it might be true we're using that metric again, but it's different now. It isn't the same author, is it?
