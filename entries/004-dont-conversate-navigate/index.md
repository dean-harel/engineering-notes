...
<audio controls style="width: 100%; max-width: 600px;">
  <source src="dont-conversate-navigate.mp3" type="audio/mpeg">
  Your browser does not support the audio element. <a href="dont-conversate-navigate.mp3">Download the audio file</a>.
</audio>
